<?php
/**
 * Please Bcc Ticketer of Batch Group & User Bccs
 *
 ...
 * @subpackage  	please
 * @description 	Bcc Ticking for Support/Faults/Management of Batch Group & User managed emails tickets
 * @version			1.0.5
...
/**
 * Class for Bcc in Please email ticketer
 *
 * For Table:-
 * <code>
 ...
 */
class pleaseBcc extends pleaseXoopsObject
{
...
/**
 * Handler Class for Bcc in Please email ticketer
 * @author Simon Roberts (wishcraft@users.sourceforge.net)
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseBccHandler extends pleaseXoopsObjectHandler
{
