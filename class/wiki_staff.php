<?php
/**
 * Please Wiki_staff Ticketer of Batch Group & User Wiki_staffs
 *
 ...
 * @subpackage  	please
 * @description 	Wiki_staff Ticking for Support/Faults/Management of Batch Group & User managed emails tickets
 * @version			1.0.5
...
/**
 * Class for Wiki_staff in Please email ticketer
 *
 * For Table:-
 * <code>
 ...
 */
class pleaseWiki_staff extends pleaseXoopsObject
{
...
/**
 * Handler Class for Wiki_staff in Please email ticketer
 * @author Simon Roberts (wishcraft@users.sourceforge.net)
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseWiki_staffHandler extends pleaseXoopsObjectHandler
{
