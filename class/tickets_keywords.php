 ...
 */
class pleaseTickets_keywords extends pleaseXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseTickets_keywordsHandler extends pleaseXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'please_tickets_keywords';
	 ...
	 * @var string
	 */
	var $child = 'pleaseTickets_keywords';
