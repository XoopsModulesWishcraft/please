<?php
/**
 * Please Wiki_keywords Ticketer of Batch Group & User Wiki_keywordss
 *
 ...
 * @subpackage  	please
 * @description 	Wiki_keywords Ticking for Support/Faults/Management of Batch Group & User managed emails tickets
 * @version			1.0.5
...
/**
 * Class for Wiki_keywords in Please email ticketer
 *
 * For Table:-
 * <code>
 ...
 */
class pleaseWiki_keywords extends pleaseXoopsObject
{
    ...
    {   	
        ...
        self::initVar('wiki-id', XOBJ_DTYPE_INT, null, false);
...
/**
 * Handler Class for Wiki_keywords in Please email ticketer
 * @author Simon Roberts (wishcraft@users.sourceforge.net)
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseWiki_keywordsHandler extends pleaseXoopsObjectHandler
{
