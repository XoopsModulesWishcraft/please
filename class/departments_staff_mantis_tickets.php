 ...
 */
class pleaseDepartments_staff_mantis_tickets extends pleaseXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseDepartments_staff_mantis_ticketsHandler extends pleaseXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'please_departments_staff_mantis_ticketses';
	 ...
	 * @var string
	 */
	var $child = 'pleaseDepartments_staff_mantis_tickets';
