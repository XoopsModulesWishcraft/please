<?php
/**
 * Please Correspondences_cc Ticketer of Batch Group & User Correspondences_ccs
 *
 ...
 * @subpackage  	please
 * @description 	Correspondences_cc Ticking for Support/Faults/Management of Batch Group & User managed emails tickets
 * @version			1.0.5
...
/**
 * Class for Correspondences_cc in Please email ticketer
 *
 * For Table:-
 * <code>
 ...
 */
class pleaseCorrespondences_cc extends pleaseXoopsObject
{
...
/**
 * Handler Class for Correspondences_cc in Please email ticketer
 * @author Simon Roberts (wishcraft@users.sourceforge.net)
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseCorrespondences_ccHandler extends pleaseXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'please_correspondences_cc';
	 ...
	 * @var string
	 */
	var $child = 'pleaseCorrespondences_cc';
