<?php
/**
 * Please Correspondences_to Ticketer of Batch Group & User Correspondences_tos
 *
 ...
 * @subpackage  	please
 * @description 	Correspondences_to Ticking for Support/Faults/Management of Batch Group & User managed emails tickets
 * @version			1.0.5
...
/**
 * Class for Correspondences_to in Please email ticketer
 *
 * For Table:-
 * <code>
 ...
 */
class pleaseCorrespondences_to extends pleaseXoopsObject
{
...
/**
 * Handler Class for Correspondences_to in Please email ticketer
 * @author Simon Roberts (wishcraft@users.sourceforge.net)
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseCorrespondences_toHandler extends pleaseXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'please_correspondences_to';
	 ...
	 * @var string
	 */
	var $child = 'pleaseCorrespondences_to';
