<?php
/**
 * Please Departments_staff_keywords Ticketer of Batch Group & User Departments_staff_keywordss
 *
 ...
 * @subpackage  	please
 * @description 	Departments_staff_keywords Ticking for Support/Faults/Management of Batch Group & User managed emails tickets
 * @version			1.0.5
...
/**
 * Class for Departments_staff_keywords in Please email ticketer
 *
 * For Table:-
 * <code>
 ...
 */
class pleaseDepartments_staff_keywords extends pleaseXoopsObject
{
...
/**
 * Handler Class for Departments_staff_keywords in Please email ticketer
 * @author Simon Roberts (wishcraft@users.sourceforge.net)
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseDepartments_staff_keywordsHandler extends pleaseXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'please_departments_staff_keywords';
	 ...
	 * @var string
	 */
	var $child = 'pleaseDepartments_staff_keywords';
