 ...
 */
class pleaseCorrespondences_relayed extends pleaseXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseCorrespondences_relayedHandler extends pleaseXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'please_correspondences_relayed';
	 ...
	 * @var string
	 */
	var $child = 'pleaseCorrespondences_relayed';
