<?php
/**
 * Please Spam_keywords Ticketer of Batch Group & User Spam_keywordss
 *
 ...
 * @subpackage  	please
 * @description 	Spam_keywords Ticking for Support/Faults/Management of Batch Group & User managed emails Spam
 * @version			1.0.5
...
/**
 * Class for Spam_keywords in Please email ticketer
 *
 * For Table:-
 * <code>
 ...
 */
class pleaseSpam_keywords extends pleaseXoopsObject
{
...
/**
 * Handler Class for Spam_keywords in Please email ticketer
 * @author Simon Roberts (wishcraft@users.sourceforge.net)
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseSpam_keywordsHandler extends pleaseXoopsObjectHandler
{
