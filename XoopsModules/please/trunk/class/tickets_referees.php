 ...
 */
class pleaseTicketsReferees extends pleaseXoopsObject
{
    ...
    {   	
        ...
        self::initVar('referee', XOBJ_DTYPE_TXTBOX, null, false, 30);
        self::initVar('relayed', XOBJ_DTYPE_INT, null, false);
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseTicketsRefereesHandler extends pleaseXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'please_tickets_referees';
	 ...
	 * @var string
	 */
	var $child = 'pleaseTicketsReferees';
