<?php
/**
 * Please Cc Ticketer of Batch Group & User Ccs
 *
 ...
 * @subpackage  	please
 * @description 	Cc Ticking for Support/Faults/Management of Batch Group & User managed emails tickets
 * @version			1.0.5
...
/**
 * Class for Cc in Please email ticketer
 *
 * For Table:-
 * <code>
 ...
 */
class pleaseCc extends pleaseXoopsObject
{
...
/**
 * Handler Class for Cc in Please email ticketer
 * @author Simon Roberts (wishcraft@users.sourceforge.net)
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseCcHandler extends pleaseXoopsObjectHandler
{
